...
3. Publish Messages for active and callable deprecated rows; publish batches only for active rows; retain release maturity independently and publish no legacy completion binding.
