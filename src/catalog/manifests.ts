...
export const manifests = [
  {
    ...
    sources: [
      ...
      },
      {
        ...
        extractorVersion: "openai-pricing-v10",
    ...
    sources: [
      {
        ...
        extractorVersion: "vercel-catalog-v17",
  ...
  },
  {
    ...
    sources: [
      ...
      },
      {
        ...
        format: "html",
        stability: "documented",
        extractor: { kind: "dashscope-lifecycle", minModels: 0, maxModels: 300 },
    ...
    sources: [
      {
        ...
        extractorVersion: "cerebras-catalog-v12",
        pricingEvidence: firstPartyPricing("model_catalog", "exact_id"),
        fields: [
          "model_id",
          "name",
