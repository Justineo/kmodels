...
export const manifests = [
  {
    ...
    sources: [
      ...
      },
      {
        ...
        format: "mixed",
        stability: "documented",
        extractor: { kind: "openai-accounting" },
        extractorVersion: "openai-accounting-v1",
    ...
    sources: [
      {
        ...
        linkedDocuments: {
          ...
          documents: fixedDocuments([
            ...
            [
              "bedrock-converse-stream-metadata",
            ...
            [
              "bedrock-invoke-guardrail-checks",
              "https://docs.aws.amazon.com/bedrock/latest/userguide/guardrails-use-invoke-guardrail-checks-using.html",
              1,
              "html",
              true,
              true,
    ...
    sources: [
      {
        ...
        extractorVersion: "vercel-catalog-v22",
        ...
        linkedDocuments: {
          ...
          documents: optionalFixedDocuments([
            ...
            [
              "image-generation",
              "https://vercel.com/docs/ai-gateway/getting-started/image.md",
              1,
              "markdown",
            ],
            [
              "video-generation",
              "https://vercel.com/docs/ai-gateway/modalities/video-generation.md",
              1,
              "markdown",
            ],
            [
              "speech-to-text",
              "https://vercel.com/docs/ai-gateway/modalities/speech-to-text.md",
              1,
              "markdown",
            ],
            [
              "reranking",
              "https://vercel.com/docs/ai-gateway/modalities/reranking.md",
              1,
              "markdown",
            ],
  ...
  },
  {
    ...
    sources: [
      ...
      {
        id: "azure-accounting",
        url: "https://learn.microsoft.com/en-us/rest/api/aifoundry/azureopenai/chat",
        type: "website",
        access: "public",
        format: "mixed",
        stability: "documented",
        extractor: { kind: "azure-accounting" },
        extractorVersion: "azure-accounting-v1",
        fields: ["pricing_inputs"],
        ...
        linkedDocuments: {
          ...
          documents: optionalFixedDocuments([
            ...
            [
              "batch",
              "https://learn.microsoft.com/en-us/rest/api/aifoundry/azureopenai/batch",
              1,
              "html",
              undefined,
              true,
            ...
            [
              "embeddings",
              "https://learn.microsoft.com/en-us/rest/api/aifoundry/azureopenai/embeddings",
              1,
              "html",
              undefined,
              true,
    ...
    sources: [
      {
        ...
        extractorVersion: "cohere-catalog-v13",
        ...
        linkedDocuments: {
          ...
          documents: fixedDocuments([
            ...
            [
              "api-chat-stream-v2",
              "https://docs.cohere.com/reference/chat-stream.md",
              1,
              undefined,
              true,
              true,
            ...
            [
              "api-chat-stream-v1",
              "https://docs.cohere.com/reference/chat-stream-v1.md",
              1,
              undefined,
              true,
              true,
  ...
  },
  {
    ...
    sources: [
      huggingFaceInferenceSource,
      {
        ...
        extractorVersion: "huggingface-router-v11",
      ...
      dashscopeCatalogSource("dashscope-embedding", "embedding-rerank-model/", "embedding", 5, 25),
      {
        ...
        linkedDocuments: {
          ...
          documents: optionalFixedDocuments([
            ...
            [
              "image-search",
              "https://www.alibabacloud.com/help/en/model-studio/image-search.md",
              1,
            ],
            [
              "text-to-image-search",
              "https://www.alibabacloud.com/help/en/model-studio/web-search-image.md",
              1,
            ],
            [
              "chat-accounting",
            ...
            [
              "native-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/qwen-api-via-dashscope.md",
              1,
            ],
            [
              "anthropic-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/anthropic-api-messages.md",
              1,
            ],
            [
              "responses-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/qwen-api-via-openai-responses.md",
              1,
            ],
            [
              "batch-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/batch-interfaces-compatible-with-openai.md",
              1,
            ],
            [
              "image-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/qwen-image-api.md",
              1,
            ],
            [
              "video-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/text-to-video-api-reference.md",
              1,
            ],
            [
              "tts-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/qwen-tts-api.md",
              1,
            ],
            [
              "music-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/fun-music-api.md",
              1,
            ],
            [
              "asr-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/non-realtime-speech-recognition-user-guide.md",
              1,
            ],
            [
              "asr-stream-accounting",
              "https://www.alibabacloud.com/help/en/model-studio/fun-asr-server-events.md",
              1,
            ],
        ...
        linkedDocuments: {
          ...
          documents: [
            ...
            })),
            {
              ...
              url: "https://raw.githubusercontent.com/Cerebras/cerebras-cloud-sdk-python/main/README.md",
              maxResponseBytes: mebibytes(1),
              optional: true,
            },
          ],
  ...
  },
  {
    ...
    pricingCategoricalLabels: pricingLabels("billing_period", {
      base: "Base",
      peak: "Peak",
    }),
    sources: [
      ...
      },
      {
        ...
        allowedHosts: ["docs.ollama.com", "ollama.com", "raw.githubusercontent.com"],
        maxResponseBytes: mebibytes(8),
        scope: "global",
        exhaustive: true,
        role: "catalog",
        ...
        linkedDocuments: {
          ...
          documents: (
            [
              ...
              [
                "api-types-v0.33.3",
                "https://raw.githubusercontent.com/ollama/ollama/v0.33.3/api/types.go",
                "markdown",
              ],
              [
                "openai-types-v0.33.3",
                "https://raw.githubusercontent.com/ollama/ollama/v0.33.3/openai/openai.go",
                "markdown",
              ],
              [
                "responses-types-v0.33.3",
                "https://raw.githubusercontent.com/ollama/ollama/v0.33.3/openai/responses.go",
                "markdown",
              ],
              [
                "openai-middleware-v0.33.3",
    ...
    sources: [
      {
        ...
        linkedDocuments: {
          ...
          documents: optionalFixedDocuments([
            ...
            ["anthropic-api", "https://api-docs.deepseek.com/guides/anthropic_api", 1],
